...
public class BaseCommerceController extends BaseController
{
	...
	@Resource(name = "customerAddressValidator")
	private Validator customerAddressValidator;
	...
	protected AddressData createAddressInternal(final HttpServletRequest request) throws WebserviceValidationException //NOSONAR
	{
		...
		validate(addressData, "addressData", customerAddressValidator);
	...
	{
		return customerAddressValidator;
	}

	protected void setAddressValidator(final Validator customerAddressValidator)
	{
