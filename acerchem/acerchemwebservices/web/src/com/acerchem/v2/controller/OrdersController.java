...
import com.acerchem.strategies.OrderCodeIdentificationStrategy;
import com.acerchem.v2.helper.OrdersHelper;
...
public class OrdersController extends BaseCommerceController
{
			...
			final HttpServletResponse response)
	{
		...
		if(statuses!=null&&!statuses.equals(""))
		{
			...
			final Errors errors = new BeanPropertyBindingResult(statusesStrings, "");
			orderStatusValueValidator.validate(statusesStrings, errors);
			if (errors.hasErrors())
			{
		...
		final OrderHistoryListWsDTO orderHistoryList = ordersHelper.searchOrderHistory(orderCode,statuses, currentPage, pageSize, sort,
	...
	{
		final OrderHistoriesData orderHistoriesData = ordersHelper.searchOrderHistory(null,statuses, 0, 1, null);
