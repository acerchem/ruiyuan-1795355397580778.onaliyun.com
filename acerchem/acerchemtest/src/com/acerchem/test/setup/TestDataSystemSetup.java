 ...
 */
package com.acerchem.test.setup;
...
import com.acerchem.test.constants.AcerchemTestConstants;
import com.acerchem.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = AcerchemTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/acerchemtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/acerchemtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/acerchemtest/import/cstickets.impex");
			...
			importImpexFile(context, "/acerchemtest/import/csquotes.impex");
		}
	}
}
