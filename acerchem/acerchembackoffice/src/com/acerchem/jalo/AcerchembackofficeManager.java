 ...
 */
public class AcerchembackofficeManager extends GeneratedAcerchembackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(AcerchembackofficeManager.class.getName());
	 ...
	 */
	public static AcerchembackofficeManager getInstance()
	{
		return (AcerchembackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(AcerchembackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AcerchembackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AcerchembackofficeManager called.");
		}
	}
