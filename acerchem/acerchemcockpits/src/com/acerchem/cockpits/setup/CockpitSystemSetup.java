 ...
 */
package com.acerchem.cockpits.setup;
...
import com.acerchem.cockpits.constants.AcerchemCockpitsConstants;
 ...
 */
@SystemSetup(extension = AcerchemCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(AcerchemCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(AcerchemCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						AcerchemCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/acerchemcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
