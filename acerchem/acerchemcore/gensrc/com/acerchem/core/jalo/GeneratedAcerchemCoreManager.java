...
public abstract class GeneratedAcerchemCoreManager extends Extension
{
	...
	static
	{
		...
		tmp.put("promotionPrice", AttributeMode.INITIAL);
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Product.promotionPrice</code> attribute.
	 * @return the promotionPrice
	 */
	public PriceRow getPromotionPrice(final SessionContext ctx, final Product item)
	{
		return (PriceRow)item.getProperty( ctx, AcerchemCoreConstants.Attributes.Product.PROMOTIONPRICE);
	}
	 ...
	 * @return the promotionPrice
	 */
	public PriceRow getPromotionPrice(final Product item)
	{
		return getPromotionPrice( getSession().getSessionContext(), item );
	}
	
	/**
	 * <i>Generated method</i> - Setter of the <code>Product.promotionPrice</code> attribute. 
	 * @param value the promotionPrice
	 */
	public void setPromotionPrice(final SessionContext ctx, final Product item, final PriceRow value)
	{
		item.setProperty(ctx, AcerchemCoreConstants.Attributes.Product.PROMOTIONPRICE,value);
	}
	 ...
	 * @param value the promotionPrice
	 */
	public void setPromotionPrice(final Product item, final PriceRow value)
	{
		setPromotionPrice( getSession().getSessionContext(), item, value );
	}
