...
public class AliyunUploadJobPerformable extends AbstractJobPerformable<CronJobModel> {
	...
	private final String lsAccessKeySecret = Config.getString("aliyun.accessKeySecret","GfyBU4iNfQftoUV20fHoYz2zNqJARy");
	...
	private void uploadFileSendProcessor(final MediaModel media, final String root) {
		...
		try {
			...
			try {
				...
				String aliyunUrl = Config.getString("aliyun.domain","https://acerchem.oss-us-east-1.aliyuncs.com") + "/" + key;
				if (uploadFlag) {
