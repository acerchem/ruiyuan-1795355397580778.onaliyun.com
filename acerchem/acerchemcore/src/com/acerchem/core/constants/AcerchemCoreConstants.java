...
/**
 * Global class for all AcerchemCore constants. You can add global constants for your extension into this class.
 */
public final class AcerchemCoreConstants extends GeneratedAcerchemCoreConstants
{
	public static final String EXTENSIONNAME = "acerchemcore";


	private AcerchemCoreConstants()
	{
		//empty
	}
