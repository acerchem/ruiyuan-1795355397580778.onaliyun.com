 ...
 */
public class ProductCountryValueProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider
{
			...
			final IndexedProperty indexedProperty)
	{
		...
		CountryModel originCountry=product.getOriginCountry();
		if (originCountry != null) {
			addFieldValues(fieldValues, indexedProperty, null, originCountry.getIsocode());
		}
		return fieldValues;
	}
