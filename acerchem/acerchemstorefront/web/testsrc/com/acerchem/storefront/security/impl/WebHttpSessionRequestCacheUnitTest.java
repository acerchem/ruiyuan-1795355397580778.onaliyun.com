...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/acerchemstorefront/electronics/en",
						"https://electronics.local:9002/acerchemstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/acerchemstorefront/electronics/en",
						"https://electronics.local:9002/acerchemstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/acerchemstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/acerchemstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/acerchemstorefront/electronics/en",
						"https://electronics.local:9002/acerchemstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/acerchemstorefront",
						"https://electronics.local:9002/acerchemstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/acerchemstorefront",
						"https://electronics.local:9002/acerchemstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/acerchemstorefront/electronics/en",
						"https://electronics.local:9002/acerchemstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
