...
/**
 * Global class for all Customerticketingaddon constants. You can add global constants for your extension into this
 * class.
 */

public final class CustomerticketingaddonConstants
{
	public static final String EXTENSIONNAME = "customerticketingaddon";

	public static final String SUPPORT_TICKETS_PAGE = "support-tickets";
	public static final String ADD_SUPPORT_TICKET_PAGE = "add-support-ticket";
	public static final String UPDATE_SUPPORT_TICKET_PAGE = "update-support-ticket";
	...
	public static final String SUPPORT_TICKET_TRY_LATER = "supporttickets-tryLater";
	...
	private CustomerticketingaddonConstants()
	{
