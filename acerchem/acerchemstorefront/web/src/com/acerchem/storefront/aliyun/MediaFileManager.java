...
public class MediaFileManager {
	...
	private static String stemp;
	 ...
	 public void init() {  
         ...
         mediaFileManager.configurationService = this.configurationService;  
	...
	public static void main(String[] args) {
		/*
		 ...
		 keys.add("application/20180313/f3");
		 try {
			 List<String> results = deleteMediaFiles(keys);
...
*/
		//new MediaFileManager();
		String s =  mediaFileManager.configurationService.getConfiguration().getString("db.driver");
