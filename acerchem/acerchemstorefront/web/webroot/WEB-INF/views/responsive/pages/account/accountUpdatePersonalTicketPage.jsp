...
<c:url value="/account/personal-ticket/${ticketData.id}" var="addSupportTicket"/>
...
<template:page pageTitle="${pageTitle}">
	<div class="member-content">
		...
		<div class="sign-content g-right">
			...
			<div class="back-link" style="padding: 0px;padding-left: 0px;padding-right: 0px;">
			    <a href="../personal-tickets">
