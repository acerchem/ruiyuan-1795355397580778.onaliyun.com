		...
		<div class="sign-content g-right">
				<div class="account-section-header ${empty supportTickets ? '':'no-border'}">
				    ...
				    <div class="account-section-header-add pull-right">
				        <a href="add-personal-ticket" class="add-address" id="add-support-ticket-btn">
				            <spring:theme code="text.account.supporttickets.requestSupport" text="Request Support" />
				        </a>
				    </div>
				</div>
				
				<c:set var="searchUrl" value="/account/personal-tickets?sort=${searchPageData.pagination.sort}"/>
						...
						<table class="responsive-table">
				            ...
				            <tbody>
				                <c:forEach items="${searchPageData.results}" var="supportTicket">
				                    <c:url value="/account/personal-ticket/${supportTicket.id}" var="myAccountsupportTicketDetailsUrl" />
				                    <tr class="responsive-table-item">
				                        ...
				                        <td>${fn:toUpperCase(supportTicket.status.id)}</td>
				                    </tr>
				                </c:forEach>
				            </tbody>
				        </table>
