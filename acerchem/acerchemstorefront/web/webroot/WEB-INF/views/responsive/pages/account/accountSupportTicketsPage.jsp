...
<c:set var="searchUrl" value="/account/support-tickets?sort=${searchPageData.pagination.sort}"/>
		...
		<table class="responsive-table">
            ...
            <tbody>
                <c:forEach items="${searchPageData.results}" var="supportTicket">
                    <c:url value="/account/support-ticket/${supportTicket.id}" var="myAccountsupportTicketDetailsUrl" />
