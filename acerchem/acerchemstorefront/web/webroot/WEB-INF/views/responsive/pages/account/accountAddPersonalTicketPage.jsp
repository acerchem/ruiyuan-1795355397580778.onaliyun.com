...
<c:url value="/account/add-personal-ticket" var="url" />
	...
	<div class="member-content">
		...
		<div class="sign-content g-right">
			...
			<div class="back-link border">
				<div class="row">
					<a href="personal-tickets"><span class="glyphicon glyphicon-chevron-left"></span></a> 
					...
					<div class="rigcont" id="support">
						<form:form method="post" commandName="supportTicketForm" id="supportTicketForm" class="both" action="${url}">
							<div>
								...
								<label> 
									<span class='label-title'>Telephone / Mobile Phone<span style="color:red;font-size: 150%;"> *</span></span> 
								...
								<span class=''>message<span style="color:red;font-size: 150%;"> *</span></span>
							...
							<div class="accountActions">
								<div class="row">
									...
									<div class="col-sm-6 col-sm-pull-6 accountButtons">
										<a href="personal-tickets" class="btn btn-default btn-block">
