...
<body class="index-body">
	...
	<div class="index-container">
		...
		<form:form method="post" commandName="vendorInventoryForm"
			action="${action}">
			...
			<div class="top-select">
				<table border="0" width="100%" cellspacing="0">
					<tbody>
						<tr>
							<td><c:choose>
									<c:when test="${vendorInventoryForm.isVendorFlag()}">
										<label>Choose Vendor:
											${vendorInventoryForm.vendorName}</label>
										<input type="hidden" name="vendor"
											value="${vendorInventoryForm.vendor}" />
									...
									<c:otherwise>
										...
										<formElement:customSelectBox idKey="vendorCode" labelKey=""
											...
											itemLabel="name"
											selectedValue="${vendorInventoryForm.vendor}" />
									</c:otherwise>
								</c:choose></td>
		...
		<div class="content">
			<div class="c-title">
				<div class="left">供应商寄售分析/商品库存</div>
	...
	<script src="${commonResourcePath}/acerchem/vendorInventoryAnalysis.js"></script>
