 ...
 * BusinessProcess.
 */
public class CustomerConsigmentConfirmAction  extends AbstractAction<OrderProcessModel>
{
	private static final Logger LOG = Logger.getLogger(CustomerConsigmentConfirmAction.class);
	...
	protected Transition executeAction(final OrderProcessModel process)
	{
		...
		if (order != null)
		{
			if(order.getCustomerConfirmDelivery()){
