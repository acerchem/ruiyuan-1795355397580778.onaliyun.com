 ...
 * BusinessProcess.
 */
public class WaitCustomerCofirmPayAction  extends AbstractAction<OrderProcessModel>
{
	private static final Logger LOG = Logger.getLogger(WaitCustomerCofirmPayAction.class);
	...
	protected Transition executeAction(final OrderProcessModel process)
	{
		...
		if (order != null)
		{
			if(order.getCustomerConfirmPay()){
