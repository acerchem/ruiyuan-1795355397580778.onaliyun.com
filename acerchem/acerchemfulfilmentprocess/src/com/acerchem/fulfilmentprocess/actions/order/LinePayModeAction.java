 ...
 * BusinessProcess.
 */
public class LinePayModeAction extends AbstractProceduralAction<OrderProcessModel>
{
	private static final Logger LOG = Logger.getLogger(LinePayModeAction.class);
