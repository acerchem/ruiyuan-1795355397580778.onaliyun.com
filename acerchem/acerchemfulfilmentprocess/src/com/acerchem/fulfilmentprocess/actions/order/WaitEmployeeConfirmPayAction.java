...
import com.acerchem.fulfilmentprocess.actions.order.WaitCustomerCofirmPayAction.Transition;
 ...
 * BusinessProcess.
 */
public class WaitEmployeeConfirmPayAction extends AbstractAction<OrderProcessModel>
{
	private static final Logger LOG = Logger.getLogger(WaitEmployeeConfirmPayAction.class);
