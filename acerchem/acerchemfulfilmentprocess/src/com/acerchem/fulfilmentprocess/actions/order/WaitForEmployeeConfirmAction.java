 ...
 * BusinessProcess.
 */
public class WaitForEmployeeConfirmAction extends AbstractAction<OrderProcessModel>
{
	private static final Logger LOG = Logger.getLogger(WaitForEmployeeConfirmAction.class);
