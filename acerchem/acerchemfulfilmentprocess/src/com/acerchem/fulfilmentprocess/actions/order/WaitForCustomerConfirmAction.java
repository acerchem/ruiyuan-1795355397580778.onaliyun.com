...
import com.acerchem.fulfilmentprocess.actions.order.CheckTransactionReviewStatusAction.Transition;
 ...
 * BusinessProcess.
 */
public class WaitForCustomerConfirmAction extends AbstractAction<OrderProcessModel>
{
	private static final Logger LOG = Logger.getLogger(WaitForCustomerConfirmAction.class);
