 ...
 */
package com.acerchem.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(AcerchemFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(AcerchemFulfilmentProcessConstants.PARENT_PROCESS);
