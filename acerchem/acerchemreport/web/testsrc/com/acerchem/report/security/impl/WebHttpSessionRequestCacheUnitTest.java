...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/acerchemreport/electronics/en",
						"https://electronics.local:9002/acerchemreport/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/acerchemreport/electronics/en",
						"https://electronics.local:9002/acerchemreport/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/acerchemreport/electronics/ja/Y/Z",
						"https://electronics.local:9002/acerchemreport/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/acerchemreport/electronics/en",
						"https://electronics.local:9002/acerchemreport/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/acerchemreport",
						"https://electronics.local:9002/acerchemreport"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/acerchemreport",
						"https://electronics.local:9002/acerchemreport/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/acerchemreport/electronics/en",
						"https://electronics.local:9002/acerchemreport/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
