...
import com.acerchem.restapi.v2.helper.StoresHelper;
...
public class StoresController extends BaseController
{
	...
	@ResponseBody
	public StoreFinderSearchPageWsDTO locationSearch(@RequestParam(required = false) final String query, //NOSONAR
	...
	/**
	 * Returns {@value com.acerchem.restapi.v2.controller.BaseController#HEADER_TOTAL_COUNT} header with the number of all store locations that are near the
