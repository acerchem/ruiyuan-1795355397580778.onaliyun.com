...
public class GeneratedTypeInitializer extends AbstractTypeInitializer
{
	...
	protected final void performCreateTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		...
		createItemType(
			...
			"CronJob",
			com.acerchem.restapi.jalo.expressupdate.cron.ProductExpressUpdateCleanerCronJob.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			"CronJob",
			com.acerchem.restapi.jalo.expressupdate.cron.OrderStatusUpdateCleanerCronJob.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			"CronJob",
			com.acerchem.restapi.jalo.OldCartRemovalCronJob.class,
			null,
			false,
			null,
			false
